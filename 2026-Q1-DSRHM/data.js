...
const FIGHTS = [
  ...
  },
  {
    ...
    builds: {
      "DPS1": { sets: ["Null/Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef Group 1. Bring Major Breach. Start upstairs." },
      "DPS2": { sets: ["Alkosh", "Deadly/Tideborn"], ult: "Colo", notes: "Alkosh DD. Start at Chalice. Permanent upstairs after." },
      "DPS3": { sets: ["Null/Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef backup (first). Start at Chalice." },
      "DPS4": { sets: ["Null/Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef Group 1. Start upstairs." },
      "DPS5": { sets: ["Null/Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef backup (second). Start at Chalice." },
      "DPS6": { sets: ["Null/Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef Group 2. Bring Major Breach. Start at Chalice." },
      "DPS7": { sets: ["Null/Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef Group 2. Start at Chalice." },
      "DPS8": { sets: ["Null/Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Start upstairs. Do first Crossbones. Can slot self-heal for portal." },
  ...
  },
  {
    ...
    builds: {
      "DPS1": { sets: ["Null", "Deadly/Tideborn", "Velothi"], ult: "Standard", notes: "Stay with group. DoT and cleave sirens." },
      "DPS2": { sets: ["Null", "Deadly/Tideborn", "Velothi"], ult: "Colo", notes: "No Alkosh on Taleria — use parse trial set. Keep Colo. Stay with group." },
      "DPS3": { sets: ["Null", "Deadly/Tideborn", "Velothi"], ult: "Standard", notes: "Bridge backup #1. Slot self-heal/shield for bridge. Bring extra pen." },
      "DPS4": { sets: ["Null", "Deadly/Tideborn", "Velothi"], ult: "Standard", notes: "Stay with group. DoT and cleave sirens." },
      "DPS5": { sets: ["Null", "Deadly/Tideborn", "Velothi"], ult: "Standard", notes: "Banner DD. 2nd bridge backup." },
      "DPS6": { sets: ["Null", "Deadly/Tideborn", "Velothi"], ult: "Standard", notes: "Bridge DD. Slot self-heal and/or shield. Bring extra pen." },
      "DPS7": { sets: ["Null", "Deadly/Tideborn", "Velothi"], ult: "Standard", notes: "Bridge DD. Slot self-heal and/or shield. Bring extra pen." },
...
const DPS_GUIDANCE = {
  subclass: "Herald/Ardent/(Storm or Assassination or Spear). Adjust build for pen/crit. Most fights allow 7 medium pieces.",
  bannerDDs: "Run Shocking/Cavalier/Courage banner.",
  beamDDs: "All beam DDs run Pragmatic Fatecarver.",
  alkoshDPS: "Always Colo for ult. Gravelord for 3rd subclass. Alkosh for all fights except Taleria (use parse trial set + Colo)."
};
