...
const FIGHTS = [
  ...
  },
  {
    ...
    builds: {
      "DPS1": { sets: ["Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef Group 1. Bring Major Breach. Start upstairs." },
      "DPS2": { sets: ["Alkosh", "Deadly/Tideborn"], ult: "Colo", notes: "Alkosh DD. Start at Chalice. Permanent upstairs after." },
      "DPS3": { sets: ["Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef backup (first). Start at Chalice." },
      "DPS4": { sets: ["Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef Group 1. Start upstairs." },
      "DPS5": { sets: ["Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef backup (second). Start at Chalice." },
      "DPS6": { sets: ["Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef Group 2. Bring Major Breach. Start at Chalice." },
      "DPS7": { sets: ["Kazpian/Whorl/Ansuul", "Deadly/Tideborn"], ult: "Standard", notes: "Reef Group 2. Start at Chalice." },
