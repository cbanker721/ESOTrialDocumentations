...
const FIGHTS = new Map([
  [FIGHT_ID.TRASH, {
    ...
    builds: {
      ...
      [MAIN_ROLE_ID.H1]:   { sets: ["SPC", "PA", "PoE", "Oze"], ult: "None", misc: ["Crusher", "Radiant"], notes: "" },
      [MAIN_ROLE_ID.H2]:   { sets: ["RO", "JO", "AD"], ult: "None", misc: ["Crusher", "Altar"], notes: "" },
  ...
  [FIGHT_ID.YASEYLA, {
    ...
    builds: {
      ...
      [MAIN_ROLE_ID.H1]:   { sets: ["SPC", "PP", "PoE", "Sym"], ult: "Glyph", misc: ["Weakening", "Radiant"], notes: "" },
      [MAIN_ROLE_ID.H2]:   { sets: ["MA", "PA", "PoE", "Oze"], ult: "Barrier", misc: ["Weakening", "Altar"], notes: "" },
  ...
  [FIGHT_ID.TWELVANE, {
    ...
    builds: {
      ...
      [MAIN_ROLE_ID.H1]:   { sets: ["SPC", "PP", "PoE", "Sym"], ult: "Glyph", misc: ["Weakening", "Radiant"], notes: "" },
      [MAIN_ROLE_ID.H2]:   { sets: ["MA", "PA", "PoE", "Oze"], ult: "Standard of Might", misc: ["Weakening", "Altar"], notes: "" },
  ...
  [FIGHT_ID.ANSUUL, {
    ...
    builds: {
      ...
      [MAIN_ROLE_ID.DPS8]: { sets: ["EC", "Z'en", "Sym"], ult: "Barrier", misc: [], notes: "Third healer, interrupt" },
      [MAIN_ROLE_ID.H1]:   { sets: ["SPC", "PP", "PoE", "Blind"], ult: "Glyph", misc: ["Weakening", "Radiant"], notes: "" },
      [MAIN_ROLE_ID.H2]:   { sets: ["MA", "PA", "PoE", "Oze"], ult: "Standard of Might", misc: ["Weakening", "Altar"], notes: "" },
      [MAIN_ROLE_ID.MT]:   { sets: ["LE", "Xoryn", "Naz"], ult: "Atro", notes: "" },
      [MAIN_ROLE_ID.OT]:   { sets: ["PW", "WM", "Baron"], ult: "Barrier", misc: ["Rapids"], otes: "Interrupt" },
    },
    buffsDebuffs: [],
    assignments: [ASSIGNMENT_ID.SE_ANSUUL_TANKS, ASSIGNMENT_ID.SE_ANSUUL_PORTAL_TEAM, ASSIGNMENT_ID.SE_ANSUUL_MANIC_TAUNT, ASSIGNMENT_ID.SE_ANSUUL_EXECUTE_ROLES, ASSIGNMENT_ID.SE_SLAYERS]
  }]
]);
