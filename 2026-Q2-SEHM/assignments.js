...
const ASSIGNMENTS = new Map([
  ...
  [ASSIGNMENT_ID.SE_SLAYER_LEFT, {
    ...
    name: "Left Slayer",
    role_ids: [MAIN_ROLE_ID.H1, MAIN_ROLE_ID.OT, MAIN_ROLE_ID.DPS1, MAIN_ROLE_ID.DPS2, MAIN_ROLE_ID.DPS3, MAIN_ROLE_ID.DPS4],
    fights: [FIGHT_ID.YASEYLA, FIGHT_ID.TWELVANE, FIGHT_ID.ANSUUL],
  }],
  [ASSIGNMENT_ID.SE_SLAYER_RIGHT, {
    id: ASSIGNMENT_ID.SE_SLAYER_RIGHT,
    name: "Right Slayer",
    role_ids: [MAIN_ROLE_ID.H2, MAIN_ROLE_ID.MT, MAIN_ROLE_ID.DPS5, MAIN_ROLE_ID.DPS6, MAIN_ROLE_ID.DPS7, MAIN_ROLE_ID.DPS8],
    fights: [FIGHT_ID.YASEYLA, FIGHT_ID.TWELVANE, FIGHT_ID.ANSUUL],
  }],
